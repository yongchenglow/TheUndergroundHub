			...
			<div class = "row">
				<div class = "col-6 description">
					<div class="selectList">
						...
						<?php
							...
							echo "
							<form method='post'>
								<select class='selectList form-control' name='intake' id='intake' onchange='this.form.submit()'>
				...
				<div class = "col-6">
					<div class="selectList">
						...
						<select class="selectList form-control" name="grade" id="grade">
							<option>A+</option>
							<option>A</option>
							<option>A-</option>
							<option>B+</option>
				...
				<div class = "col-12">
					<p class="center"> Type your Advice below </p>
				...
				<div class = "col-8">
					<table class ="content">
						<tr class ="rowContent">
							<td class= "radio">
								<label>
									<input type="radio" name="textbook" id="option1" value="1"> Yes
								</label>
							</td>
							<td class= "radio"> 
								<label>
									<input type="radio" name="textbook" id="option2" value="0"> No
								</label>
							</td>
						</tr>
					</table>	
				...
				<div class = "col-8">
					<table class ="content">
						<tr class ="rowContent">
							<td class= "radio">
								<label>
									<input type="radio" name="lecture" id="option1" value="1"> Yes
								</label>
							</td>
							<td class= "radio"> 
								<label>
									<input type="radio" name="lecture" id="option2" value="0"> No
								</label>
							</td>
						</tr>
					</table>	
				...
				<div class = "col-8">
					<table class ="content">
						<tr class ="rowContent">
							<td class= "radio">
								<label>
									<input type="radio" name="tutorials" id="option1" value="1"> Yes
								</label>
							</td>
							<td class= "radio"> 
								<label>
									<input type="radio" name="tutorials" id="option2" value="0"> No
								</label>
							</td>
						</tr>
					</table>	
				...
				<div class = "col-8">
					<table class ="content">
						<tr class ="rowContent">
							<td class= "radio">
								<label>
									<input type="radio" name="webLecture" id="option1" value="1"> Yes
								</label>
							</td>
							<td class= "radio"> 
								<label>
									<input type="radio" name="webLecture" id="option2" value="0"> No
								</label>
							</td>
						</tr>
					</table>	
						...
						if (isset($_POST['submit']))
						{
							...
							if(!$difficulty && !$textbook && !$lecture && !$tutorials && !$webLecture && !$teachingLevel && !$hotness){
								...
								$updateDiffculty = "
									...
									SET LevelOfDifficulty = LevelOfDifficuly + '$difficulty'
								...
								$updateTextbook = "
									UPDATE GeneralInformation
									SET Textbook = Textbook + $textbook
									WHERE Identification = '$id'
								";
								...
								$updateTutorials = "
									UPDATE GeneralInformation
									SET Tutorials = Tutorials + $tutorials
									WHERE Identification = '$id'
								";
								...
								$updateWebLecture= "
									UPDATE GeneralInformation
									SET WebLecture = WebLecture + $webLecture
									WHERE Identification = '$id'
								";
								...
								if($result2-> num_rows > 0){
									while($rows = $result2-> fetch_assoc())
									{
										...
										$updateTeach = "
											UPDATE Professors
											SET TeachingLevel = TeachingLevel + '$teach'
											WHERE Name = '$name'
										";
								...
								// Updating of Advice
								$grade = $_POST['grade'];
								$recommendation = $_POST['advice'];
								$insertAdvice = "INSERT INTO Advice(Identification,Grade,Recommendation) VALUES ('$id','$grade','$recommendation')";
